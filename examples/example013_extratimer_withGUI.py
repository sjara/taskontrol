...
class Paradigm(QtGui.QMainWindow):
    def __init__(self, parent=None, paramfile=None, paramdictname=None):
        ...
        self.params['periodOn'] = paramgui.NumericParam('Period On',value=2,
                                                        group='Timing Parameters')
        self.params['periodOff'] = paramgui.NumericParam('Period Off',value=2,
                                                         group='Timing Parameters')
    ...
    def set_state_matrix(self, nextTrial):
        ...
        '''self.sm.add_state(name='first_state', statetimer=timeOn,
                          ...
                          outputsOn=['centerLED'])
        self.sm.add_state(name='second_state', statetimer=timeOff,
                          transitions={'Cin':'third_state','Tup':'ready_next_trial'},
                          outputsOff=['centerLED'])
        self.sm.add_state(name='third_state', statetimer=0,
                          transitions={'Tup':'first_state'},
                          trigger=['mytimer'])
        self.sm.add_state(name='fourth_state', statetimer=500,
                          transitions={'Tup':'ready_next_trial'},
