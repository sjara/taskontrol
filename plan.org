...
* To do next:
*** TODO A simple protocol with one parameter defining the time of a clock.
*** TODO A simple protocol organized by trials.
...
***** TODO Write the client
      ~/tmp/newbcontrol/Modules/@RTLSoundMachine
      /SoundTrigClient/SoundTrigClient.cpp
